...
const Gradient = () => {
  return (
    <div className="w-full opacity-20 absolute">
      <div className="h-90 overflow-hidden" id="bg-wrap">
        <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
          ...
          <rect x="0" y="0" width="100%" height="60%" fill="url(#Gradient4)">
            <animate
              attributeName="x"
              dur="20s"
              values="25%;0%;25%"
          ...
          <rect x="0" y="0" width="100%" height="50%" fill="url(#Gradient6)">
            <animate
              attributeName="x"
              dur="25s"
              values="-25%;0%;-25%"
