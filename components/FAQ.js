...
const FAQ = () => {
  return (
    <section id="faq" className="py-5 w-full bg-bg font-abel">
      <h3 className="lg:text-5xl text-3xl tracking-wide font-serifdm font-bold mb-8 text-bg-dark text-center">
        FAQ
      </h3>
      <div className="max-w-6xl px-5 lg:px-0 mx-auto flex lg:flex-row flex-col justify-between lg:gap-20">
        <div className="flex flex-col lg:w-1/2">
          <div className="mb-5">
            <p className="text-bg-dark lg:text-xl text-lg font-semibold mb-1">
              What is an NFT?
            </p>
